...
GC_10 = Coupling(name = 'GC_10',
                 value = 'KWW*((ee**2*complex(0,1))/(2.*sw**2))',
                 order = {'QED':2})
...
GC_29 = Coupling(name = 'GC_29',
                 value = 'KZZ*(ee**2*complex(0,1) + (cw**2*ee**2*complex(0,1))/(2.*sw**2) + (ee**2*complex(0,1)*sw**2)/(2.*cw**2))',
                 order = {'QED':2})
...
GC_31 = Coupling(name = 'GC_31',
                 value = 'KW*((ee**2*complex(0,1)*v)/(2.*sw**2))',
                 order = {'QED':1})

GC_32 = Coupling(name = 'GC_32',
                 value = 'KZ*(ee**2*complex(0,1)*v + (cw**2*ee**2*complex(0,1)*v)/(2.*sw**2) + (ee**2*complex(0,1)*sw**2*v)/(2.*cw**2))',
                 order = {'QED':1})
